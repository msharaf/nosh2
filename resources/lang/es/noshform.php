...
return [
    ...
    */
    ...
    // Encounters
    "medical_encounter" => "Physical Therapy Daily Treatment Note",
    "phone_encounter" => "Phone Encounter",
    "virtual_encounter" => "Virtual Encounter",
    "standardpsych" => "Physical Therapy Initial Evaluation",
    "standardpsych1" => "Physical Therapy Plan of Care/Progress Note",
    ...
    "pe" => "Physical Exam/Treatment Performed",
    ...
    "duration1" => "Visit Duration",
    "duration2" => "Visit Duration",
    "sign" => "Sign",
    "preview" => "Preview",
    ...
    "primary_care_provider" => "Physical Therapist",
